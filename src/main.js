...
const VOICE_MODEL_MODEL = "tts-1"; // TODO honestly should I even make this customizable? The model works really well, and the next step up costs sooooo much more to use.
